...
class SettingsController extends Controller
{
    public function general_information()
    {
        ...
        return view('admin.crm.setup.general', compact('data'))->with('rec', $rec);
    ...
    function email()
    {
       ...
       return view('admin.crm.setup.email', compact('data'))->with('rec', $rec);
    }
    ...
    {       
        ...
        try{
            ...
            $mail = Mail::to($request->test_email_address);
    ...
    function email_template_home()
    {
        ...
        return view('admin.crm.setup.email_template_main', compact('template_list'));
    }
