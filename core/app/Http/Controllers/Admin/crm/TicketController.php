...
class TicketController extends Controller
{
    ...
    function index()
    {
        ...
        $data['stat']   = Ticket::statistics();
   	    ...
   	    return view('admin.crm.support.index', compact('data'))->with('rec', []); 
    }
...
//
    ...
    public function create()
    {
        ...
        return view('admin.crm.support.create_ticket', compact('data'))->with('rec', $rec);
    }
    ...
    function show(Ticket $ticket)
    {
        ...
        $permission = check_perm(['customers_view']);
        if(!$permission)
        {
            abort(404);
        }
    	...
    	return view('admin.crm.support.show_ticket', compact('data'))->with('rec', $ticket);
    }
