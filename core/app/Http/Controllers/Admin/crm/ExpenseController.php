...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.crm.expense.index');
    }
    ...
    function paginate()
    {
        ...
        ->with(['category', 'project', 'customer', 'payment_mode', 'invoice']);
...
//
        ...
        if (count($data) > 0)
        {
            foreach ($data as $key => $row)
            {
                ...
                if(check_perm('expenses_edit')||check_perm('expenses_delete')){
                    $delete_btn = '<a href="'.route('delete_expense', $row->id).'" class="delete_item btn btn-danger btn-sm" title="Delete"><i class="icon-trash icon"></i></a>';
    ...
    public function create()
    {
        ...
        return view('admin.crm.expense.create', compact('data'))->with('rec', []);
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        return view('admin.crm.expense.create', compact('data'))->with('rec', $expense);
    ...
    function get_expense_details_ajax()
    {
        ...
        $rec->amount_after_tax    =$rec->amount_after_tax;
