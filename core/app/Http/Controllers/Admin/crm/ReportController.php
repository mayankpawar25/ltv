...
class ReportController extends Controller
{
    ...
    { 
      ...
      //   ORDER BY month ASC");
        ...
        return view('admin.crm.reports.expenses', compact('data'))->with('expenses', $expense_categories);
    ...
    function download_expense_report(Request $request)
    {
        ...
        $data['html'] = view('admin.crm.reports.pdf.expenses', compact('data') )->with('expenses', $expense_categories)->render();
    ...
    {
        return view('admin.crm.reports.activity_log');
    }
