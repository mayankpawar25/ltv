...
class DepartmentController extends Controller {
    ...
    function index()
    {
        return view('admin.crm.support.department');
    }
            ...
            foreach ($data as $key => $row)
            {
                ...
                $rec[] = array(
                    ...
                    /*side_by_side_links($row->id, route('delete_department', $row->id) )*/
                     anchor_link('<button class="btn btn-sm btn-danger pull-right"><span class="icon-trash icons" data-toggle="tooltip" title="Delete"></span></button>',route('delete_department',$row->id),'','settings_').' '. 
