...
class TicketPriorityController extends Controller {
    ...
    function index()
    {
        return view('admin.crm.support.priority');
    }
            ...
            foreach ($data as $key => $row)
            {
                ...
                $rec[] = array(
                    ...
                    /*side_by_side_links($row->id, route('delete_ticket_priority', $row->id) )*/
                     ...
                     anchor_link('<button class="btn btn-sm btn-danger pull-right"><span class="icon-trash icons" data-toggle="tooltip" title="Delete"></span></button>',route('delete_ticket_priority',$row->id),'','settings_').' '. 
