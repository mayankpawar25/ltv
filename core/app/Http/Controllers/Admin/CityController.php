...
class CityController extends Controller
{
	...
	public function index(Request $request){
	        ...
	        return datatables()->of(DB::table('cities As t')
	                ...
	                $button = '<a href="'.route('cities.edit',$data->id).'" name="edit" id="'.$data->id.'" class="edit btn btn-info btn-sm " data-toggle="tooltip" title="Edit"><i class="icon-pencil icon"></i></a>';
	                $button .= '&nbsp;&nbsp;';
