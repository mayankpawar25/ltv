          ...
          <div class="main-content">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="">
                  <div class="">
                    <h5 style="color:#2d2d2d"><i class="fa fa-desktop"></i> Current Icon</h5>
                  </div>
                  <div class="">
              ...
              <div class="col-md-3">
                <div class="">
                  <div class="">
                    <h5 style="color:#2d2d2d"><i class="fa fa-desktop"></i> Header Logo</h5>
                  </div>
                  <div class="">
              ...
              <div class="col-md-3">
                <div class="">
                  <div class="">
                    <h5 style="color:#2d2d2d"><i class="fa fa-desktop"></i> Footer Logo</h5>
                  </div>
                  <div class="">
