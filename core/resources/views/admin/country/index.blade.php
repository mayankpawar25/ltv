	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="main-content">
				<form class="form-horizontal m-t-20" role="form" id="loginform" method="POST" enctype="multipart/form-data" action="{{ (isset($country->id))?route('countries.update'):route('countries.store') }}">
					   {{ csrf_field() }}
					<div class="">
						<h5 class="">{{ (isset($country->id))?'Edit Country':'Add New Country' }}</h5><hr />
						<div class="text-left">
...
function getStatus(data, type, full, meta) {
	...
	$(document).on('click', '.status', function(){
		...
		// console.log(user_id,brand_status);
