	            ...
	            <div class="row form-group">
	              ...
	              <div class="col-sm-4">
	                <div class="form-group">
                		...
                		@else
	                  	<img src="{{ asset('assets/shopkeeper/'.$shopkeeper->folder.'/'.$document->image_name) }}" alt="Shop Pic" style="width:100px">
	                  	@endif
	                  	<a href="{{ route('admin.document.delete',[$shopkeeper->id,$dc_key]) }}"><i class="fa fa-trash"></i></a>
...
<script type="text/javascript">
  ...
  $(document).on('click','#add_more_docs',function(){
    ...
    html += '<input type="file" name="doc[]" onchange="imagePreview(this,\'preview'+count+'\')" accept="">';
