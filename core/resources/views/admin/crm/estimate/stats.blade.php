...
?>
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="shadow-sm p-1 mb-5 bg-light rounded text-center">
                        {{ $stat[ESTIMATE_STATUS_DRAFT]['total']  }}
                ...
                <div class="col-md-3">
                    <div class="shadow-sm p-1 mb-5 bg-light rounded text-center">
                        {{ $stat[ESTIMATE_STATUS_SENT]['total']  }}
                ...
                <div class="col-md-3">
                    <div class="shadow-sm p-1 mb-5 bg-light rounded text-center">
                        {{$stat[ESTIMATE_STATUS_EXPIRED]['total']  }}
                ...
                <div class="col-md-3">
                    <div class="shadow-sm p-1 mb-5 bg-light rounded text-center">
                        {{ $stat[ESTIMATE_STATUS_DECLINED]['total']  }}
        ...
        <div class="col-md-3">
            <div class="shadow-sm p-1 mb-5 bg-light rounded text-center">
                {{ $stat[ESTIMATE_STATUS_ACCEPTED]['total'] }}
