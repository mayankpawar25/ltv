<htmlpageheader name="firstpageheader" style="display:none">
   <div class="row">
      ...
      <div class="col-md-6 text-right">
         <h1 style="margin-bottom: 0; color: #007bff; font-size: 26px;">{{  strtoupper(__('form.estimate')) }}</h1>
         <div>{{ $rec->number }}</div>
   ...
   <div class="col-sm-6 text-right">
      <div class="bold">@lang('form.ship_to'):</div>
      <address style="font-size: 12px;">
      ...
      <div style="font-size: 12px;">
         <div>@lang('form.estimate_date') : {{ sql2date($rec->date) }}</div>
         <div>
            @lang('form.expiry_date') : {{ sql2date($rec->expiry_date) }}    
         </div>
         <div>
            @lang('form.sales_agent') : {{ (isset($rec->sales_agent->name)) ? $rec->sales_agent->name : ' ' }}                 
         </div>
      </div>
   </div>
</htmlpageheader>
