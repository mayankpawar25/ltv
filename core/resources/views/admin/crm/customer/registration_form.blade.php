<div class="row">
   <div class="col-md-6">
      <div class="form-group">
         ...
         <input type="text" class="form-control  {{ showErrorClass($errors, 'contact_first_name') }}" name="contact_first_name" value="{{ old_set('contact_first_name', NULL, $rec) }}">
      ...
      <div class="form-group">
         ...
         <input type="text" class="form-control {{ showErrorClass($errors, 'contact_last_name') }}" name="contact_last_name" value="{{ old_set('contact_last_name', NULL, $rec) }}">
         <div class="invalid-feedback">{{ showError($errors, 'contact_last_name') }}</div>
      </div>
      <div class="form-group">
         <label>@lang('form.email') <span class="required">*</span></label>
         <input type="email" class="form-control {{ showErrorClass($errors, 'contact_email') }}" name="contact_email" value="{{ old_set('contact_email', NULL, $rec) }}" >
         <div class="invalid-feedback">{{ showError($errors, 'contact_email') }}</div>
      </div>
      <div class="form-group">
         <label>@lang('form.position')</label>
         <input type="text" class="form-control {{ showErrorClass($errors, 'contact_position') }}" 
      ...
      <div class="form-group">
         ...
         <input type="password" class="form-control {{ showErrorClass($errors, 'contact_password') }}" name="contact_password" value="{{ old_set('contact_password', NULL, $rec) }}">
      ...
      <div class="form-group">
         ...
         <input type="password" class="form-control {{ showErrorClass($errors, 'repeat_password') }}" name="repeat_password" value="{{ old_set('repeat_password', NULL, $rec) }}">
         <div class="invalid-feedback">{{ showError($errors, 'repeat_password') }}</div>
      </div>
      <div class="form-group">
         <label>@lang('form.phone')</label>
         <input type="text" class="form-control {{ showErrorClass($errors, 'contact_phone') }}" name="contact_phone"  value="{{ old_set('contact_phone', NULL, $rec) }}">
   ...
   <div class="col-md-6">
      ...
      <div class="form-group">
         ...
         <textarea id="address" name="address" class="form-control " >{{ old_set('address', NULL, $rec) }}</textarea>
