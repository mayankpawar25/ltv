...
@section('title', __('form.customer_groups'))
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">@lang('form.customer_group')</h5>
    ...
    <script>
        $(function() {
            ...
            var dataTable = $('#data').DataTable({
                ...
                // ],
                "ajax": {
                    "url": '{!! route("datatables_customer_groups") !!}',
                    "type": "POST",
                    'headers': {
            ...
            $('#submitForm').click(function (e) {
                ...
                var url = (id) ? "{{ route("patch_customer_group") }}" : "{{ route("post_customer_group") }}";
        ...
        $(document).on('click','.edit_item',function(e){
            ...
            $.post( "{{ route("get_information_customer_group") }}", { "_token": "{{ csrf_token() }}", id : id})
                .done(function( response ) {
