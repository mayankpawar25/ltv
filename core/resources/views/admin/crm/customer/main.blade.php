...
<div class="app-content">
   ...
   @if($group_name == '')
   @include('admin.crm.customer.profile')
   @elseif($group_name == 'show_form')
   @include('admin.crm.customer.form')
   @elseif($group_name == 'contacts')
   @include('admin.crm.customer.contacts')
   @elseif($group_name == 'invoices')
   @include('admin.crm.customer.invoices')
   @elseif($group_name == 'payments')
   @include('admin.crm.customer.payments')
   @elseif($group_name == 'proposals')
   @include('admin.crm.customer.proposals')
   @elseif($group_name == 'estimates')
   @include('admin.crm.customer.estimates')
   @elseif($group_name == 'expenses')
   @include('admin.crm.customer.expenses')
   @elseif($group_name == 'tasks')
   @include('admin.crm.customer.tasks')
   @endif
</div>
@endsection
