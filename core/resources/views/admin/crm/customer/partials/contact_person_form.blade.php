   ...
   <div class="form-group col-md-3">
      ...
      <div class="input-group">
         <input type="password" class="form-control  {{ showErrorClass($errors, 'contact_password') }}" name="contact_password" value="{{ old_set('contact_password', NULL, $rec) }}" id="password">
   ...
   <div class="form-group col-md-3">
      <label>@lang('form.phone') (@lang('form.primary_contact')) <span class="required">*</span></label>
