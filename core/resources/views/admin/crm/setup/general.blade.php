...
<form role="form" class="form-horizontal" enctype="multipart/form-data" action="{{ route('patch_company_information') }}" method="post" autocomplete="off" >
   ...
   <div class="main-content">
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="form-group">
               ...
               <input type="text" class="form-control  {!! $errors->has('settings.company_name') ? ' is-invalid' : '' !!}" name="settings[company_name]" value="{{ old_set('company_name', NULL, $rec) }}">
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_phone') ? ' is-invalid' : '' !!}" name="settings[company_phone]" value="{{ old_set('company_phone', NULL, $rec) }}">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_email') ? ' is-invalid' : '' !!}" name="settings[company_email]" value="{{ old_set('company_email', NULL, $rec) }}">
            ...
            <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="settings[company_vat_number]" value="{{ old_set('company_vat_number', NULL, $rec) }}">
               </div>
            <div class="form-row">
               <div class="form-group col-md-4">
                  <label>@lang('form.decimal_symbol') <span class="required">*</span></label>
                  <?php
                     echo form_dropdown('settings[decimal_symbol]', $data['dropdowns']['decimal_symbol'], old_set('decimal_symbol', NULL, $rec) , "class='form-control  selectPickerWithoutSearch'");
                     ?>
               </div>
               <div class="form-group col-md-4">
                  <label>@lang('form.thousand_seperator') <span class="required">*</span></label>
                  <input type="text" class="form-control  {!! $errors->has('settings.digit_grouping_symbol') ? ' is-invalid' : '' !!}" name="settings[digit_grouping_symbol]" value="{{ old_set('digit_grouping_symbol', NULL, $rec) }}">
               ...
               <div class="form-group col-md-4">
                  ...
                  <?php
                     echo form_dropdown('settings[digit_grouping_method]', $data['dropdowns']['list_of_digit_grouping_methods'], old_set('digit_grouping_method', NULL, $rec) , "class='form-control  selectPickerWithoutSearch'");
                     ?>
               </div>
            </div>
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <?php
                     echo form_dropdown('settings[time_zone]', $data['dropdowns']['time_zone'], old_set('time_zone', NULL, $rec) , "class='form-control  selectpicker' data-live-search='true'");
                     ?>
               </div>
               <div class="form-group col-md-6">
                  <label>@lang('form.language') <span class="required">*</span></label>
                  <?php
                     echo form_dropdown('settings[default_language]', $data['dropdowns']['languages'], old_set('default_language', NULL, $rec) , "class='form-control  selectPickerWithoutSearch '");
                     ?>
               </div>
            </div>
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <textarea class="form-control  {!! $errors->has('settings.company_address') ? ' is-invalid' : '' !!}" rows="4" name="settings[company_address]">{{ old_set('company_address', NULL, $rec) }}</textarea>
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_city') ? ' is-invalid' : '' !!}" name="settings[company_city]" value="{{ old_set('company_city', NULL, $rec) }}">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_state') ? ' is-invalid' : '' !!}" name="settings[company_state]" value="{{ old_set('company_state', NULL, $rec) }}">
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_country') ? ' is-invalid' : '' !!}" name="settings[company_country]" value="{{ old_set('company_country', NULL, $rec) }}">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control  {!! $errors->has('settings.company_zip_code') ? ' is-invalid' : '' !!}" name="settings[company_zip_code]" value="{{ old_set('company_zip_code', NULL, $rec) }}">
          ...
          <div class="form-group">
               ...
               $days = [
                  ...
                  echo form_dropdown('settings[first_day_of_week]', $days , old_set('first_day_of_week', NULL, $rec) , "class='form-control  selectPickerWithoutSearch '");
                  ?>
            </div>   
      ...
      @include('admin.crm.setup.google_recaptcha')
