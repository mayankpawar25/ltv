...
@section('title', __('form.settings') . " : " .__('form.leads_sources'))
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">@lang('form.lead_source')</h5>
        ...
        $(function() {
            ...
            dataTable = $('#data').DataTable({
               ...
               /* buttons: [
                ...
                // ],
                "ajax": {
                    "url": '{!! route("datatables_leads_source") !!}',
                    "type": "POST",
                    'headers': {
            ...
            $('#submitForm').click(function (e) {
                ...
                var url = (id) ? "{{ route('patch_lead_source', ':id') }}" : "{{ route('post_lead_source') }}";           
