                    ...
                    <form method="post" action='{{ (isset($rec->id)) ? route( 'patch_lead', $rec->id) : route('post_lead') }}'>
                        ...
                        <div class="form-row">
                            ...
                            @if(auth()->user()->is_administrator)
                                ...
                                @endphp
                            @endif
                            <div class="form-group col-md-4 {{ $class }}">
                        ...
                        @endif
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm @php if($errors->has('alt_number_one')) { echo 'is-invalid'; } @endphp"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm @php if($errors->has('alt_number_two')) { echo 'is-invalid'; } @endphp"
