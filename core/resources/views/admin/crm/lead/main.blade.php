        ...
        <div class="row">
          <div class="col-md-9">
              ...
              <div class="main-content">
                 ...
                 <br>
                 @if($group_name == '')
                    @include('admin.crm.lead.contact')
                 @elseif($group_name == 'notes')
                    @include('admin.crm.lead.notes')
                 @elseif($group_name == 'proposals')
                    @include('admin.crm.lead.proposals')  
                 @elseif($group_name == 'tasks')
                    @include('admin.crm.lead.tasks') 
                 @elseif($group_name == 'activity_log')
                    @include('admin.crm.lead.activities')  
...
@include('admin.crm.lead.partials.log_touch')
