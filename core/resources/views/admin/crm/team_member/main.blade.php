...
<div class="app-content">
  <div class="">
    ...
    @if($group_name == '')
        @include('admin.crm.team_member.profile')
    @elseif($group_name == 'show_form')
        @include('admin.crm.team_member.form')
    @elseif($group_name == 'tasks')
        @include('admin.crm.team_member.tasks')
    @elseif($group_name == 'notifications')
        @include('admin.crm.team_member.notifications')
    @elseif($group_name == 'change-password' && (auth()->user()->id == $rec->id))
        @include('admin.crm.team_member.change_password')    
    @endif
        </div>
    </div>
</div>
