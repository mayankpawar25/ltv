...
<div class="main-content" style="margin-bottom: 10px !important"> @include('admin.crm.team_member.partials.profile_menu') </div>
<div class="row">
  <div class="col-md-3 col-sm-4"> @include('admin.crm.team_member.partials.profile_photo') </div>
          ...
          <div style="padding: 0px;">
            ...
            <div class="table-responsive">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                <tr>
                  <td width="25%">@lang('form.email')</td>
                  <td width="25%">{{ $rec->email }}</td>
                  <td width="25%">@lang('form.phone')</td>
                  <td width="25%">{{ $rec->phone }}</td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
              <tr>
                <td width="25%">@lang('form.bank_account_no').</td>
                <td width="25%">{{  (isset($rec->bank_account_no)) ? $rec->bank_account_no : ""  }}</td>
                <td width="25%">@lang('form.bank_ifsc_code')</td>
                <td width="25%">{{  (isset($rec->bank_ifsc_code)) ? $rec->bank_ifsc_code : ""  }}</td>
              </tr>
              <tr>
