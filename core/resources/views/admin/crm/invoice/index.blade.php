              ...
              <div class="col-md-6">
                 <div class="float-md-right">
                       @if(check_perm('invoices_create'))
                        ...
                        @endif
                         <!-- <a class="btn btn-primary btn-sm" href="{{ route('recurring_invoices_list') }}" role="button">@lang('form.recurring_invoices')</a> -->
...
@include('admin.crm.invoice.partials.vue_js_template_child_invoices')

@include('admin.crm.invoice.partials.vue_js_template_settings')
...
<template id="receive_payment_template" >
    @include('admin.crm.invoice.partials.receive_payment_vue_js')
</template>
</div>
