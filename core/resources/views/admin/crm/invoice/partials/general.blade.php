    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group d-none">
                ...
                echo form_dropdown('project_id', $data['project_id_list'] , old_set('project_id', NULL,$rec), "class='form-control   project_id $errorClass '");
        ...
        ?>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control  initially_empty_datepicker  @php if($errors->has('due_date')) { echo 'is-invalid'; } @endphp" name="due_date" value="{{ $due_date_value }}">
            ...
            <div class="form-row">
                ...
                @if(!auth()->user()->is_administrator)
                    ...
                    @endphp
                @endif
                <div class="form-group col-md-6 {{ $hidden_class }}">
