...
<div style="margin-bottom: 20%;">
   <div class="main-content" style="margin-bottom: 10px !important">
      ...
      <hr>
      @include('admin.crm.support.partials.navigation')
   </div>
   @if($group_name == '')
   @include('admin.crm.support.partials.add_reply')
   @elseif($group_name == 'note')
   @include('admin.crm.support.partials.add_note')
   @elseif($group_name == 'other-tickets')
   @include('admin.crm.support.partials.other_tickets')    
   @elseif($group_name == 'tasks')
   @include('admin.crm.support.partials.tasks')
   @elseif($group_name == 'settings')
   @include('admin.crm.support.partials.form')
   @endif
   <hr>
   <h4>@lang('form.conversations')</h4>
   <hr>
   @include('admin.crm.support.partials.comment_thread')
</div>
</div>
@endsection
@section('onPageJs')
