...
@section('title', __('form.services'))
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">@lang('form.service')</h5>
    ...
    <script>
        $(function() {
            ...
            var dataTable = $('#data').DataTable({
                ...
                // ],
                "ajax": {
                    "url": '{!! route("datatables_ticket_services") !!}',
                    "type": "POST",
                    'headers': {
            ...
            $('#submitForm').click(function (e) {
                ...
                var url = (id) ? "{{ route("patch_ticket_service") }}" : "{{ route("post_ticket_service") }}";
        ...
        $(document).on('click','.edit_item',function(e){
            ...
            $.post( "{{ route("get_information_ticket_services") }}", { "_token": "{{ csrf_token() }}", id : id})
                .done(function( response ) {
