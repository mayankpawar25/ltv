...
<form>
   ...
   <div class="form-row">
       ...
       <div class="form-group col-md-2">
        <label>@lang('form.status')</label>
        <?php
            echo form_dropdown('status_id', $data['status_id_list'] , [], "class='form-control four-boot' multiple='multiple' ");
        ?>
        </div>
...
<table class="table dataTable table-bordered no-footer dtr-inline collapsed" width="100%" id="data">
    <thead>
        <tr>
            ...
            <th>@lang("form.discount")</th>
            <th>@lang("form.adjustment")</th>
            <th>@lang("form.applied_credit")</th>
            <th>@lang("form.amount_open")</th>
