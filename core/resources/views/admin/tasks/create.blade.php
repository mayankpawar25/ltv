                    ...
                    <div class="row">
                      <div class="col-sm-3">
                       ...
                       <div class="form-group">
                          ...
                          <select name="salesman_id" id="salesman_select" class="salesman_select form-control select2" required> </select>
                        </div>
                      ...
                      <div class="col-sm-3">
                       <div class="form-group">
                          ...
                          <select name="client_id" id="client_list" class="client_list form-control select2" required> </select>
                        </div>
                        </div>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label>Task Date: </label>
                          <input type="text" name="task_date" class="form-control date" id="task_date" required>
                       ...
                       <div class="form-group">
                         ...
                         <div class="input-group bootstrap-timepicker">
                          <input type="text" name="from_time" id="from_timepicker" class="from_timepicker form-control" value="09:00" required/>
                        </div>
                        </div>
                      </div>
                       ...
                       <div class="col-sm-3">
                         <div class="form-group">
                          <label> To Time: </label>
                         <div class="input-group bootstrap-timepicker">
                           <input type="text" name="to_time" id="to_timepicker" class="to_timepicker form-control" value="10:00" required/>
                         </div>
  ...
  $( document ).ready( function () {
    ...
    $( "#task-section" ).validate( {
        ...
        messages: {
            ...
            from_time: {
                required: "Please Select Task Time.",
            },
            to_time:{
              required : "Please Select Task To Time",
            },
