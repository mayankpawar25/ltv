                                              ...
                                              <table class="table table-bordered" id="datatableOne">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <span>{{$gs->base_curr_symbol}} {{round($orderedproduct->product_price, 2)}}</span>
                                                      ...
                                                      <td class="">
                                                        ...
                                                        @else
                                                        <span>{{$gs->base_curr_symbol}} {{round($orderedproduct->product_price, 2)*$orderedproduct->quantity}}</span>
                                                        @endif
                                                      </td>
                                                    </tr>
                                                    @endforeach
