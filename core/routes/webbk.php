...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin','set_user_permission','set_global_config']], function () {
	...
	/* Product Create , Edit, Update, List */
  	Route::get('/product/index', 'Admin\ProductController@index')->name('admin.product.index');
  	Route::get('/product_pagination', 'Admin\ProductController@paginate')->name('datable_products');
	...
	Route::get('/product/{id}/getimgs', 'Vendor\ProductController@getimgs')->name('admin.product.getimgs');

	Route::post('/product/getsubcategories', 'Vendor\ProductController@getsubcats')->name('admin.product.getsubcats');
	Route::get('/product/getattributes', 'Vendor\ProductController@getattributes')->name('admin.product.getattributes');
	/* Product Create , Edit, Update, List */

	/* Wholeseller / Distributor Create , Edit, Update, List */
  	Route::get('/shopkeeper/index/', 'Admin\ShopkeeperController@index')->name('admin.shopkeeper.index');
	...
	/* Transaction Details */
	Route::get('/transactions/{client_type_id?}/{shopkeeper_id?}', 'Admin\ShopkeeperController@transactions')->name('admin.shopkeeper.transaction');
